...
def config_parser(cmd=None):
    ...
    parser.add_argument('--idx_view',
     ...
     ########## memory optimization ##########
    parser.add_argument('--actnn', action='store_true', help='applying actnn') # AISYS ADDED
    #parser.add_argument('--gact', action='store_true', help='applying gact')  
    parser.add_argument("--opt_level", type=str, help="Optimization level of actnn") # AISYS ADDED
    parser.add_argument("--bit", type=float, help="target average precision") # AISYS ADDED
    parser.add_argument("--aq-bit", type=float, help="aq_bit scheme") # AISYS ADDED
    parser.add_argument("--get-mem", action='store_true', help="get memory") # AISYS ADDED


    ########## mixed precision ################
    parser.add_argument('--amp', action='store_true', help='applying amp') # AISYS ADDED
